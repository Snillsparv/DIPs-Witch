  ...
  38 0006 7860     		str	r0, [r7, #4]
   7:C:/mop/c/Moplaborationer/DIPs-Witch/C\player.c **** 	this->animation_counter++;
  39              		.loc 1 7 0
  ...
  44 0010 1A62     		str	r2, [r3, #32]
   8:C:/mop/c/Moplaborationer/DIPs-Witch/C\player.c **** 	if (this->animation_counter == this->animation_speed) {
  45              		.loc 1 8 0
  ...
  51 001c 0FD1     		bne	.L2
   9:C:/mop/c/Moplaborationer/DIPs-Witch/C\player.c **** 		this->animation_counter = 0;
  52              		.loc 1 9 0
  53 001e 7B68     		ldr	r3, [r7, #4]
  54 0020 0022     		movs	r2, #0
  55 0022 1A62     		str	r2, [r3, #32]
  10:C:/mop/c/Moplaborationer/DIPs-Witch/C\player.c **** 		this->current_frame = (this->current_frame + 1) % this->n_frames;
  56              		.loc 1 10 0
  ...
  70              	.L2:
  11:C:/mop/c/Moplaborationer/DIPs-Witch/C\player.c **** 	}
  12:C:/mop/c/Moplaborationer/DIPs-Witch/C\player.c **** 	
  13:C:/mop/c/Moplaborationer/DIPs-Witch/C\player.c **** 	static lastRightValue = 0;
  14:C:/mop/c/Moplaborationer/DIPs-Witch/C\player.c **** 	static lastLeftValue = 0; 
  15:C:/mop/c/Moplaborationer/DIPs-Witch/C\player.c **** 	static speed = 0;
  16:C:/mop/c/Moplaborationer/DIPs-Witch/C\player.c **** 	
  17:C:/mop/c/Moplaborationer/DIPs-Witch/C\player.c **** 	if (!lastRightValue && read_DIL_single(RIGHT_TRIGGER)){
  71              		.loc 1 17 0
  ...
  80 004e 04D0     		beq	.L3
  18:C:/mop/c/Moplaborationer/DIPs-Witch/C\player.c **** 		speed += SPEED_ADD;
  ...
  87              	.L3:
  19:C:/mop/c/Moplaborationer/DIPs-Witch/C\player.c **** 	}
  20:C:/mop/c/Moplaborationer/DIPs-Witch/C\player.c **** 	
  21:C:/mop/c/Moplaborationer/DIPs-Witch/C\player.c **** 	if (!lastLeftValue && read_DIL_single(LEFT_TRIGGER)){
  88              		.loc 1 21 0
  ...
  97 006a 04D0     		beq	.L4
  22:C:/mop/c/Moplaborationer/DIPs-Witch/C\player.c **** 		speed -= SPEED_ADD;
 ...
 104              	.L4:
  ...
  24:C:/mop/c/Moplaborationer/DIPs-Witch/C\player.c **** 	
  25:C:/mop/c/Moplaborationer/DIPs-Witch/C\player.c **** 	this->xPos += speed;
 105              		.loc 1 25 0
 ...
 112 0082 5A60     		str	r2, [r3, #4]
  ...
  27:C:/mop/c/Moplaborationer/DIPs-Witch/C\player.c **** 	if (speed > 0){
 113              		.loc 1 27 0
 114 0084 124B     		ldr	r3, .L7+4
 115 0086 1B68     		ldr	r3, [r3]
 116 0088 002B     		cmp	r3, #0
 117 008a 05DD     		ble	.L5
  28:C:/mop/c/Moplaborationer/DIPs-Witch/C\player.c **** 		speed--;
 118              		.loc 1 28 0
 ...
 124 0096 08E0     		b	.L6
 125              	.L5:
  29:C:/mop/c/Moplaborationer/DIPs-Witch/C\player.c **** 	}
  30:C:/mop/c/Moplaborationer/DIPs-Witch/C\player.c **** 	else if (speed < 0){
 126              		.loc 1 30 0
 127 0098 0D4B     		ldr	r3, .L7+4
 128 009a 1B68     		ldr	r3, [r3]
 129 009c 002B     		cmp	r3, #0
 130 009e 04DA     		bge	.L6
  31:C:/mop/c/Moplaborationer/DIPs-Witch/C\player.c **** 		speed++;
 131              		.loc 1 31 0
 ...
 137              	.L6:
  32:C:/mop/c/Moplaborationer/DIPs-Witch/C\player.c **** 	}
  33:C:/mop/c/Moplaborationer/DIPs-Witch/C\player.c **** 	
  34:C:/mop/c/Moplaborationer/DIPs-Witch/C\player.c **** 	lastRightValue = read_DIL_single(RIGHT_TRIGGER);
 138              		.loc 1 34 0
 ...
 143 00b4 1A60     		str	r2, [r3]
  35:C:/mop/c/Moplaborationer/DIPs-Witch/C\player.c **** 	lastLeftValue = read_DIL_single(LEFT_TRIGGER);
 144              		.loc 1 35 0
 ...
 149 00c0 1A60     		str	r2, [r3]
  36:C:/mop/c/Moplaborationer/DIPs-Witch/C\player.c **** 	
  37:C:/mop/c/Moplaborationer/DIPs-Witch/C\player.c **** }...
 150              		.loc 1 37 0
 151 00c2 C046     		nop
 ...
 178              		.text
 179              	.Letext0:
 180              		.file 2 "C:/mop/c/Moplaborationer/DIPs-Witch/C/sprite.h"
 181              		.file 3 "C:/mop/c/Moplaborationer/DIPs-Witch/C/image.h"
 182              		.file 4 "C:/mop/c/Moplaborationer/DIPs-Witch/C/gameobject.h"
